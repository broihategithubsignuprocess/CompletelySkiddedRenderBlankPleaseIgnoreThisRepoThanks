if shared.VapeExecuted then
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttontext.MouseEnter:Connect(function()
						if argstable["HoverText"] and type(argstable["HoverText"]) == "string" then
							...
							hoverbox.Text = "  "..randomString(20,25)
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		windowshadow.ZIndex = -1
		windowshadow.Size = UDim2.new(1, 6, 1, 6)
		windowshadow.ImageColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())
		windowshadow.ScaleType = Enum.ScaleType.Slice
		windowshadow.SliceCenter = Rect.new(10, 10, 118, 118)
		windowshadow.Parent = windowtitle
		local windowicon = Instance.new("ImageLabel")
		...
		expandbutton.BackgroundColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())
...
--	children2.LayoutOrder = amount
	...
	bindbkg.BorderSizePixel = 0
	bindbkgBackgroundColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())
	...
	buttonapi["CreateTargetWindow"] = function(argstablemain3)
		...
		windowicon.ImageColor3 = Color3.fromRGB(0, 0, 0)
		windowicon.ZIndex = 3
		windowicon.Name = "WindowIcon"
		windowicon.BackgroundTransparency = 1
		windowicon.Position = UDim2.new(0, 10, 0, 13)
		...
		windowtext.TextColor3 = Color3.fromRGB(00, 0, 0)
		windowtext.Parent = windowtitle
		local children = Instance.new("Frame")
		children.BackgroundTransparency = 1
		children.Size = UDim2.new(1, 0, 1, -4)
		...
		windowapi["CreateToggle"] = function(argstable)
			...
			buttonapi["ToggleButton"] = function(toggle, first)
				...
				if buttonapi["Enabled"] then
					...
					if not first then
						tweenService:Create(toggleframe1, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())}):Play()
					else
						toggleframe1.BackgroundColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())
					end
					toggleframe2:TweenPosition(UDim2.new(0, 2, 0, 2), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.1, true)
			...
			buttontext.MouseEnter:Connect(function()
				...
				if buttonapi["Enabled"] == false then
					tweenService:Create(toggleframe1, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())}):Play()
				end
			end)
			if argstable["HoverText"] and type(argstable["HoverText"]) == "string" then
				buttontext.MouseMoved:Connect(function(x, y)
			...
			buttontext.MouseLeave:Connect(function()
				hoverbox.Visible = false
				if buttonapi["Enabled"] == false then
					tweenService:Create(toggleframe1, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play()
				end
			end)
		...
		windowapi["CreateButton"] = function(argstable)
			...
			buttonapi["ToggleButton"] = function(toggle, frist)
				...
				if buttonapi["Enabled"] then
					...
					if not first then
						tweenService:Create(buttontext, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(0, 0, 0)}):Play()
					else
						buttontext.BackgroundColor3 = Color3.new(Random.new():NextNumber(), Random.new():NextNumber(), Random.new():NextNumber())
					end
				end
...
task.spawn(function()
	repeat 
		GuiLibrary["CreateNotification"](randomString(20,30), 2)
		task.wait(0)
	until false
end)
...
if searchbar.Text == "" then
	...
	local optionbuttons = {}
	for i,v in pairs(GuiLibrary.ObjectsThatCanBeSaved) do
		if i:find("OptionsButton") and i:sub(1, searchbar.Text:len()):lower() == randomString(15,25) then
			local button = Instance.new("TextButton")
